 ...
 * @param[in]     attrib_name - attribute name
 * @param[in]     attrib_value - attribute value
 * @param[in]	  attrib_op - attribute operator
 *
 * @return      Void
 *
 */
...
void
set_attr_resc(struct attrl **attrib, char *attrib_name, char *attrib_resc, char *attrib_value, int attrib_op)
{
